...
int main(int argc, char *argv[]) {
    try {
        ...
        else if (FLAGS_at == "yolov4") {
            model.reset(new ModelYolo4(FLAGS_m, (float)FLAGS_t, FLAGS_auto_resize, FLAGS_yolo_af, (float)FLAGS_iou_t, labels));
        }
        else if (FLAGS_at == "yolov5") {
            model.reset(new ModelYolo5(FLAGS_m, (float)FLAGS_t, FLAGS_auto_resize, FLAGS_yolo_af, (float)FLAGS_iou_t, labels));
        }
        else {
